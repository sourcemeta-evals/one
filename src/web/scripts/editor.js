...
export class Editor {
  ...
  highlight(range, color) {
    ...
    // columnStart is 1-indexed, so valid range is 1 to lineLength + 1
    ...
    // columnEnd represents the end position (exclusive), valid range is 0 to lineLength
  ...
  highlights() {
    ...
    while (cursor.value !== null) {
      ...
      // Convert absolute positions to line/column format
      ...
      const style = decoration.spec.attributes?.style || "";
